@extends('visiteur.master_visiteur')
@section('visiteur')  
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="about__image">
                                <img src="{{(!empty($about->about_image))? url($about->about_image):url('backend/images/small/img-5.')}}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="about__info__wrap">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="about-tab">
                                        <p class="desc">{{ $about->about_description }}</p>
                ...
                <div class="container">
                    <div class="row gx-0 justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="blog-details.html"><img src="{{asset('frontend/assets/img/blog/blog_post_thumb01.')}}')}}" alt=""></a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-9">
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    <a href="blog-details.html"><img src="{{asset('frontend/assets/img/blog/blog_post_thumb02.')}}" alt=""></a>
                                    <div class="blog__post__tags">
